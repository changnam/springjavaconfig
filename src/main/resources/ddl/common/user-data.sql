...
insert into users(id, username, email,enabled) values(1,'John Cena','john@gmail.com', false);
insert into users(id, username, email,enabled) values(2,'Salman Khan','salman@gmail.com', false);
insert into users(id, username, email,enabled) values(3,'Amitr Khan','amir@gmail.com', true);
